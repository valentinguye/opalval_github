...
merge m:1 firm_id using "$base_path_wd\build\input\mill_geolocalization\pre2011_bad_desa_id.dta", generate(merge_baddesa) keepusing(firm_id)
...
sort firm_id year
export excel using "$base_path_wd\build\input\mill_geolocalization\mills_to_georeference_pre2011.xls", firstrow(variables) replace
******************************************************************************************************************************
******************************************************************************************************************************
...
merge m:m firm_id using "$base_path_wd\build\input\mill_geolocalization\noto.dta", generate(merge_noto)
...
export excel using "$base_path_wd\build\input\mill_geolocalization\noto.xls", firstrow(variables) replace
******************************************************************************************************************************
******************************************************************************************************************************
